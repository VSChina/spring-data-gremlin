...
public class Constants {
    ...
    public static final String GREMLIN_PRIMITIVE_PROPERTY = "property('%s', '%s')";
    ...
    public static final String GREMLIN_VERTEX_DROP = String.join(GREMLIN_PRIMITIVE_INVOKE,
            GREMLIN_PRIMITIVE_GRAPH,
            GREMLIN_PRIMITIVE_VERTEX_ALL,
            GREMLIN_PRIMITIVE_DROP
    );

    public static final String GREMLIN_EDGE_DROP = String.join(GREMLIN_PRIMITIVE_INVOKE,
            GREMLIN_PRIMITIVE_GRAPH,
